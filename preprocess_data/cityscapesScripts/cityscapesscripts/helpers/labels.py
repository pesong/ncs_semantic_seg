...
labels = [
    ...
    Label(  'bus'                  , 28 ,        9 , 'vehicle'         , 7       , True         , False        , (  0, 60,100) ),
    Label(  'caravan'              , 29 ,        9 , 'vehicle'         , 7       , True         , True         , (  0,  0, 90) ),
    Label(  'trailer'              , 30 ,        9 , 'vehicle'         , 7       , True         , True         , (  0,  0,110) ),
    Label(  'train'                , 31 ,        9 , 'vehicle'         , 7       , True         , False        , (  0, 80,100) ),
