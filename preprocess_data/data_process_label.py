...
path_name = '/media/pesong/e/dl_gaussian/data/bdd100k/seg/gray_labels/total_labels/'

for file in os.listdir(path_name):
    file_path = path_name + str(file)
    with Image.open(file_path) as img:
        resized = img.resize((480, 320))
        resized.save("/media/pesong/e/dl_gaussian/data/bdd100k/seg/gray_labels/total_320_480/" + str(file))